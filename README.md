...
Telegram-бот для продажи персональных SOCKS5-прокси с тарифами, сроком действия и заглушкой оплаты.
...
- После подтверждения оплаты (заглушка) бот выдаёт SOCKS5 в формате Telegram:
